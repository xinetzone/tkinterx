...
class CanvasMeta(Canvas):
    ...
    def create_graph(self, graph_type, directions, color='blue', width=0, tags=None, **kwargs):
        ...
        graph_id = self._create(graph_type, directions, kwargs)
        return graph_id

    def _create_square_graph(self, graph_type, center, radius, color='blue', width=0, tags=None, **kw):
        ...
        kw.update({'color': color, 'width': width, 'tags': tags})
        return self.create_graph(graph_type, direction, **kw)

    def create_circle(self, center, radius, color='blue', width=0, tags=None, **kw):
        '''
        :param center: (x, y) The center of the circle
        :param radius: Radius of the circle
        '''
        return self._create_square_graph('oval', center, radius, color, width, tags, **kw)

    def create_square(self, center, radius, color='blue', width=0, tags=None, **kw):
        '''
        :param center: (x, y) The center of the square
        :param radius: Radius of the square
        '''
        return self._create_square_graph('rectangle', center, radius, color, width, tags, **kw)

    def create_point(self, position, color='blue', width=0, tags=None, **kw):
        '''
        :param location: (x, y) The location of the point
